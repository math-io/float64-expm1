...
// ln(2) * 56:
var LN2x56 = 3.88162421113569373274e+01; // 0x4043687a9f1af2b1

// ln(2) * 0.5:
var LN2_HALF = 3.46573590279972654709e-01; // 0x3fd62e42fefa39ef

// ln(2) * 1.5:
var LN2_HALFx3 = 1.03972077083991796413e+00; // 0x3ff0a2b23f3bab73
...
function expm1( x ) {
	...
	if ( y > LN2_HALF ) { // if |x| > 0.5*ln(2)
		if ( y < LN2_HALFx3 ) { // if |x| < 1.5*ln(2)
			...
			k = k|0; // use a bitwise OR to cast `k` to an integer (see alow asm.js type annotations: http://asmjs.org/spec/latest/#annotations)
			t = k;
	...
	r1 = 1.0 + z*(Q1+z*(Q2+z*(Q3+z*(Q4+z*Q5))));
