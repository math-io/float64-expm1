...
function expm1( x ) {
	...
	if ( hx >= 1078159482 ) {
		...
		if ( hx >= 1082535490 ) {
			// Check if the exponent is all 1s: 01111111111100000000000000000000 => 0x7ff00000 = 2146435072
			if ( hx >= 2146435072 ) {
				// Remove the exponent by applying a mask ('00000000000011111111111111111111' => 0xfffff = 1048575):
